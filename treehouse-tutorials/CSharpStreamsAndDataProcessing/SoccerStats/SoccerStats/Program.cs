...
namespace SoccerStats
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < ReadSoccerResults(fileName).Count; i++)
            {
                GameResult c = ReadSoccerResults(fileName)[i];
                Console.WriteLine(c);
            }
            Console.ReadLine();
        ...
        {
            var webClient = new WebClient();
            webClient.Headers.Add("Ocp-Apim-Subscription-Key", "16a79eb6e7c64619a7cdb4b86c70b2c5");
